...
@section('title',$user->name . ' ' . '(@'.$user->username.') adlı kişinin takipçileri')
        ...
        <div class="main-body" style="margin-top: 2.4rem;">
              ...
              <div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="col-md-7">
                    ...
                    <h5 class="titleFont" style="margin-bottom: 1rem;">Takipçiler</h5>
                 ...
                 @auth
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap" >
                      <a href="{{route('getProfile', ['username'=> $follower->user->username])}}" style="color:inherit;"><img src="<?=url('/')?>/images/avatars/{{$follower->user->photo}}" class="rounded-circle" width="45" height="45"><h6 style="padding-left:0.4rem; color: #000;"> 
                      {{$follower->user->name}}
                      <br>
                      <small  class="text-muted" > {{"@".$follower->user->username}}</small></a>
                      <br>
                      <small  class="text" > {{$follower->user->info}}</small>
                      ...
                      @php
                          $check= Follow::where('user_id',Auth::user()->id)->where('follower_id',$follower->user->id)->first();
                      @endphp
                      ...
                      @else
                        @if($check)
                          <h6  style="margin-left: auto;" ><a href="{{route('unfollow',['id'=>$follower->user->id])}}" id="unfollow" type="submit" class="site-btn unfollowButton2" >takibi bırak</a>
                          </h6>
                        
                        @else
                        <h6  style="margin-left: auto;" ><a href="{{route('follow',['id'=>$follower->user->id])}}" id="follow" type="submit" class="site-btn followButton2"  >takip et</a>
